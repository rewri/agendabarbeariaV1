...
class EstablishmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'city' => ['type' => 'string', 'length' => 80, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'enabled' => 1,
                'created' => '2020-07-10 11:13:49',
                'modified' => '2020-07-10 11:13:49',
            ],
        ];
        parent::init();
    }
