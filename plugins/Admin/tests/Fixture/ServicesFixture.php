...
class ServicesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'duration_in_minutes' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '30', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'enabled' => 1,
                'created' => '2020-07-06 11:09:44',
                'modified' => '2020-07-06 11:09:44',
            ],
        ];
        parent::init();
    }
