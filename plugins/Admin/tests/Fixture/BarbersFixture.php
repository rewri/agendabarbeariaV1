 ...
 * BarbersFixture
 */
class BarbersFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'available' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '1', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'barbers_ibfk_1' => ['type' => 'foreign', 'columns' => ['establishment_id'], 'references' => ['establishments', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'available' => 1,
                'enabled' => 1,
                'created' => '2020-07-06 11:09:51',
                'modified' => '2020-07-06 11:09:51',
            ],
        ];
        parent::init();
    }
