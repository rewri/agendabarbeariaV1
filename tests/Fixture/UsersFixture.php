...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nickname' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'enabled' => 1,
                'created' => '2020-07-06 10:38:00',
                'modified' => '2020-07-06 10:38:00',
            ],
        ];
        parent::init();
    }
